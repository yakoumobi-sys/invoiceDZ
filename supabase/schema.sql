...
-- Crée les tables clients & produits et protège toutes les données par utilisateur (RLS).
-- Sans ce script, le site fonctionne quand même : clients et produits restent sur l'appareil.
...
-- Sécurité des documents existants : chaque utilisateur ne voit que les siens.
